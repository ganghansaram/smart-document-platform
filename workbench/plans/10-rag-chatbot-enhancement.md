...
| **Phase 2** | 쿼리 분해 + 메타데이터 인덱싱 + 컨텍스트 확장 | ⬜ 대기 | 예상 5-7일, Phase 1 선행 |
| **Phase 3** | Agentic RAG 루프 + 질문 라우터 + 신뢰도 | ⬜ 대기 | 예상 7-10일, Phase 2 선행 |
| **Phase 4** | 사내 MLOps 엔드포인트 연동 | ⬜ 대기 | 예상 2-3일, Phase 1-C 선행 |
| **Phase 5** | 세션 영속화, 프롬프트 설정, 피드백, 표 QA | ⬜ 선택 | 각 2-3일, 독립 적용 가능 |
