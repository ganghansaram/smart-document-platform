...
> **상태: ✅ 완료 (2026-07-16) — 완료분 기준 종료. 저작 풀사이클(2a) ✅ + 에디터 디자인 토큰·다크 브리지 ✅ + 3a/3c DOCX 내보내기 ✅ + 4 "작성 문서" 자동 메뉴 편입 ✅.**
> **⤳ 저작 기능은 Plan-70(교정 이전)으로 Author 로 이동함.** 미완 기능(소유권·표지·하드닝·검색연동·admin 큐레이션)은 종료 조건 아님 → **Author 인계 백로그**(`backlog.md`)로 이관. 상세는 Plan-70 참조.
> ~~상태: 🟡 Phase 2·3·4 진행 중 — … 남음: 2b 소유권·3b 표지·하드닝·검색연동·admin 큐레이션·회귀~~
