...
**현 위치**: 묶음 1 **6/7 (86%)** + 묶음 2 **1/4 (25%)** 완료 — Phase 3 UI 재설계 P1 영역(라벨·4그룹·출처마커·가독성·빈상태) 적용. 잔여: 묶음 1 캘리브레이션 + 묶음 2 모달 A/사이드바 3단/검사설정 UI.
...
- ⏸️ 묶음 2 단계 2 — Phase 5 도움말 L1/L3 + 모달 A/C
- ⏸️ 묶음 2 단계 3 — 검사 설정 5옵션 UI 토글
- ⏸️ 묶음 2 단계 4 — 사이드바 3단 재구성 (검사설정 패널) + 재캘리브레이션
