...
> 목표: 차이를 보는 것에서 "처리하는 것"으로 — 수락/거절 + 결과 내보내기

- [ ] **2.5-1. 변경 수락/거절 (Accept/Reject)**
  - [ ] 각 변경 항목에 ✓(수락) / ✗(거절) 버튼
...
- [ ] **4-2. 커스텀 규칙 고도화**
  - [x] 용어 치환 폼 (금지 용어 추가/삭제 — Phase 3-3에서 구현)
  - [x] 용어 그룹 관리 (일관성 검사용 — Phase 3-3에서 구현)
  - [ ] CSV 일괄 업로드 (용어 사전 임포트)
  - [ ] AI 기반 규칙 (자연어 검사 기준)
...
- [ ] **4-5. UX 고도화**
  - [ ] 미니맵/개요 바 (스크롤바 옆 컬러 마커 — 변경 위치 개요)
  - [ ] 통합 뷰 (Unified View) 토글 — 단일 패널에 inline diff
  - [ ] 3-way 비교 (공통 조상 + A + B)
