...
- **Python 3.11 이상** (3.11.9 권장, portable 버전 또는 설치 파일)
  - 파일명 예: `python-3.11.9-amd64.exe` 또는 `python-3.11.9-embed-amd64.zip`
  - 용도: 검색 인덱스 업데이트, 백엔드 서버, 문서 변환
  - 가상환경(`.venv`) 사용 권장 — [백엔드 설치 가이드](03-BACKEND-SETUP.md) 참조
