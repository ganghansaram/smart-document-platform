/* ===================================
   Docker 전용 설정 파일
   Nginx가 /js/config.js 요청 시 이 파일로 alias 됨
   → js/config.js와 구조·값이 동일해야 하며,
     오직 backendUrl·ollamaUrl만 상대경로('')로 덮어씀
   =================================== */
...
const AI_CONFIG = {
    ...
    backendUrl: '',    // Docker: '' (Nginx 동일 포트 프록시)        
